...
const FacebookAuthButton = ({ onClick, isSignIn }) => {
  return (
    <button onClick={onClick} className="w-full bg-blue-500 border-gray-300 border-2 text-white text-lg font-semibold rounded-md flex items-center gap-2 py-2 px-4">
